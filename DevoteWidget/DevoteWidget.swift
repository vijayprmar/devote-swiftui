...
//  DevoteWidget
//
//  Created by Vijay Parmar on 17/11/22.
//
        ...
        GeometryReader {geeometry in
            ZStack{
                ...
                Image("logo")
                    ...
                    .offset(x:(geeometry.size.width / 2) - 20, y :(geeometry.size.height / -2) + 20 )
                ...
                .padding()
                .offset(y:( geeometry.size.height/2)-24)
            }//Zstack
        }//Geometory
...
struct DevoteWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .description("This is an example for the prsonal task manager.")
    }
}
